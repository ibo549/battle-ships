...
{
    public class WhenShipHit : Specification<BattleShipBoard, BattleShipCommandHandlers, ShootTarget>
    {
        ...
        {
            return new ShootTarget(_boardId, new BoardPoint(0,2));
        }
        ...
        {
            Assert.IsType<ShipHit>(PublishedEvents.First());
        }
